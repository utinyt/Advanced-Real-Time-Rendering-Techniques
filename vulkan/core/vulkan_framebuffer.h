...
public:
	...
	void addAttachment(VkImageCreateInfo imageCreateInfo, VkMemoryPropertyFlags memoryProperties, VkImageLayout imageLayoutOverride = VK_IMAGE_LAYOUT_UNDEFINED,
		bool earlyLayoutTransition = false);
